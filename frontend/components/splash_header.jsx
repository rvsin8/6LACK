                        ...
                        <div>
                            <div className="firstcol">
                                <div>
                                    ...
                                    <div className="team">
                                        With channelss in 6lack, you and your team know where to go to ask questions, share updates and stay in the loop on your music.
                            </div>
                                    <br />
                        ...
                        <div className="header-div-2">
                            <div>
                                <video className="animation-1"
                                    autoPlay
                                    loop
                                    src="https://a.slack-edge.com/5f6f2/marketing/img/homepage/hp-prospect/channelss/bring-your-team-together-in-channelss.mp4"
                                    type="video/mp4"
                                    id="animation2"
                                    muted
                                />
                            ...
                            <div>
                                <div className="seccol">
                                    ...
                                    <form className="splash-form" src={"./channelss"} onClick={() => this.handleClick()}>
