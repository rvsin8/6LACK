            ...
            <div>
              <div className="firstcol">
                <div>
                  ...
                  <div className="team">
                    With channels in 6lack, you and your team know where to go
                    to ask questions, share updates and stay in the loop on your
                    music.
                  </div>
                  <br />
              ...
              <div>
                <div className="seccol">
                  ...
                  <p className="unlike-text">
                    Unlike email, conversations in 6lack are easy to follow. And
              ...
              <div>
                <div className="thirdcol">
                  <p className="unlike-text-2">
                    “I help share my sound from the studio to others in my
                    neighborhood, and all around the world” Valentine explains.
                    “[With 6lack] there’s no wasted time or wasted music because
                    you’re able to communicate things right away.” Ricardo
                    Valdez Valentine Artist, East Atlanta.
                  </p>
                  <div className="youtube">
                    <iframe
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/iSgUMPHQEWw"
