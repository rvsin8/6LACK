...
channels_1 = Channel.create!(admin_id: sean.id, name: "new-signings", is_private: false)
channels_2 = Channel.create!(admin_id: jermaine.id, name: "collabs", is_private: false)
channels_3 = Channel.create!(admin_id: sean.id, name: "label-meeting", is_private: false)
#M
